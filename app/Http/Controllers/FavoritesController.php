...
class FavoritesController extends Controller
{
    ...
    public function show()
    {
        ...
        $favorites = Favorite::where('id_person', $idUser)->get();

        $movies = [];

        foreach ($favorites as $favorite) {
            $movie = Content::where('id', $favorite['id_content'])->first();
    ...
    public function check(Request $request)
    {
        ...
        if ($content) {
            ...
            if (Favorite::where([['id_person', $idUser],['id_content', $id_content]])->exists()) {
    ...
    {
        // para criar o novo registro de favoritos, primeiro deve ser criado CASO ainda não exista, um registro na tabela
        ...
        /// já tem, basta apenas pegar o seu id e criar um registro nos favoritos com o seu id no content
        if ($haveContentOrNull) {
            $this->createFavorite($haveContentOrNull);
        } else {
    ...
    public function createFavorite($content)
    {
        $idUser = Auth::id();
    ...
    public function delete($id)
    {
        ...
        if ( $content ) {
            ...
            $deleted = Favorite::where('id_content', $content['id'])->delete();
